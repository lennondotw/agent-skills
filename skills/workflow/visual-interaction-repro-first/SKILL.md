...
await page.goto("http://localhost:4061/today");
await page.locator("[data-pane-sidebar-toggle]").click();

const samples = await page.evaluate(async () => {
  const read = () => {
    const panel = document.querySelector("#opal-right-sidebar");
...
- Surface: `http://localhost:4061/today`
